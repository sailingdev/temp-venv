...
# Generated 2016-09-18 17:34:10.215324 by PyXB version 1.2.5 using Python 2.7.12.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:04787b0c-7df0-11e6-9fa4-3497f68b2e96')
...
class listOfAnyURI (pyxb.binding.basis.STD_list):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.mjW1MNk/PyXB-1.2.5/pyxb/bundles/wssplat/schemas/sawsdl.xsd', 8, 2)
    _Documentation = None
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.mjW1MNk/PyXB-1.2.5/pyxb/bundles/wssplat/schemas/sawsdl.xsd', 17, 4)
    _ElementMap = {}
    _AttributeMap = {}
...
attrExtensions = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'attrExtensions'), CTD_ANON, location=pyxb.utils.utility.Location('/tmp/pyxbdist.mjW1MNk/PyXB-1.2.5/pyxb/bundles/wssplat/schemas/sawsdl.xsd', 16, 2))
