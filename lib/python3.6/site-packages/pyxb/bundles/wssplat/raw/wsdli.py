...
# Generated 2016-09-18 17:34:08.681384 by PyXB version 1.2.5 using Python 2.7.12.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:038ecd90-7df0-11e6-9fa4-3497f68b2e96')
...
class STD_ANON (pyxb.binding.basis.STD_list):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.mjW1MNk/PyXB-1.2.5/pyxb/bundles/wssplat/schemas/wsdli.xsd', 30, 4)
    _Documentation = None
