...
# Generated 2016-09-18 17:34:12.276080 by PyXB version 1.2.5 using Python 2.7.12.final.0
...
class STD_ANON (pyxb.binding.datatypes.Name, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.mjW1MNk/PyXB-1.2.5/pyxb/bundles/dc/schemas/dcmitype.xsd', 33, 8)
    _Documentation = None
...
class DCMIType (pyxb.binding.basis.STD_union):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/pyxbdist.mjW1MNk/PyXB-1.2.5/pyxb/bundles/dc/schemas/dcmitype.xsd', 31, 2)
    _Documentation = None
